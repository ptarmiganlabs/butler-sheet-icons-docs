...
| `--capture-overview-after <true\|false>` | `BSI_QSCLOUD_CST_CAPTURE_OVERVIEW_AFTER` | Capture a second screenshot of the app overview after the thumbnails have been applied, showing the result rather than the starting state. Costs one extra browser login per app                                                                                                                                                                                              | `true`        | -                                                      |
