...
| `--host <host>`                          | `BSI_QSEOW_CST_HOST`                   | Host name or IP address of the Qlik Sense server, with or without "https://" in front. Example: "sense.example.com" or "https://sense.example.com"                                                                                                                                                                                                                            | **Required**              | `--host qlik-server.company.com`               |
...
| `--host <host>`                      | `BSI_QSEOW_RSI_HOST`                | Host name or IP address of the Qlik Sense server, with or without "https://" in front. Example: "sense.example.com" or "https://sense.example.com"                                                                              | **Required**            | -                          |
